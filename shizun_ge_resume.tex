...
% add new log var used in \github
\newif\ifisGithubProject
\isGithubProjectfalse % default to false
\newcommand{\address}[1]{
...
\newcommand{\github}[1]{
  \ifisGithubProject
  \BeginAccSupp{ActualText={Github: https://github.com/#1}} \href{https://github.com/#1}{#1} \faGithub\EndAccSupp{}
  \else
  \BeginAccSupp{ActualText={Github: https://#1}} \href{https://#1}{#1} \faGithub\EndAccSupp{}
  \fi
}
...
% define porjects
% name, stars, image pulls, description
\newcommand{\githubProject}[4]{
  \isGithubProjecttrue
  \github{#1}\\
  {#4}\\
  \stars{#2}\imagePulls{#3}\\
  \isGithubProjectfalse
  \vspace{0.5em}
}
